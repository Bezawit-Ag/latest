...
# For local development, keep this True so you can see detailed error pages.
DEBUG = True
...
# For local development, use Django's default staticfiles storage.
# When deploying to Render, you can switch back to
